  ...
  <section class="tab-content" id="pills-tabContent" >
    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0" >
      <x-card-design :header="__('Total Deposits')" >
        <x-data-table :id="__('depositTable')" :striped="true" :hover="true" :theme="__('black')" :headers="['SL', 'Name of Gamer', 'Amount', 'Trx ID', 'Action']" :datatable="true" >
    ...
    <div class="tab-pane fade" id="pills-pending" role="tabpanel" aria-labelledby="pills-pending-tab" tabindex="0" >
      <x-card-design :header="__('Pending Deposits')" >
        <x-data-table :id="__('pendingTable')" :striped="true" :hover="true" :theme="__('black')" :headers="['SL', 'Name of Gamer', 'Amount', 'Trx ID', 'Action']" :datatable="true" >
