        ...
        <div class="card" >
          <div class="card-header" >
            <div class="d-flex justify-content-between align-items-center" >
              <h4 class="card-title" >{{ __('Manage Genre') }}</h4>
              <div class="nav-item topbar-icon dropdown hidden-caret" >
                ...
                <ul class="dropdown-menu fadeIn py-1" >
                  <a class="dropdown-item py-2" href="{{ route('genre.create') }}" >
              ...
              <table id="homeTable" class="display table table-striped table-hover table-head-bg-black datatables" >
                ...
                <tbody>
                  @foreach ($genres as $key => $genre)
                    <tr>
                      {{-- <td>{{ str_pad($loop->iteration, strlen(count($genre)), '0', STR_PAD_LEFT) . '.' }}</td> --}}
                      <td style="padding-top: 0.75rem !important; padding-bottom: 0.75rem !important;" >
                        <strong>{{ $genre->title }}</strong>
                      </td>
                      <td style="padding-top: 0.75rem !important; padding-bottom: 0.75rem !important;" >{{ $genre->description }}</td>
                      <td style="padding-top: 0.75rem !important; padding-bottom: 0.75rem !important;" >
