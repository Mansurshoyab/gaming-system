  ...
  <div class="sidebar-logo" >
    ...
    <div class="logo-header" data-background-color="dark" >
      <a href="{{ route('admin.dashboard') }}" class="logo" >
        <img src="{{ Storage::url('company/' . $company->logo) ?? asset('images/company/' . config('company.logo')) }}" alt="Logo" class="navbar-brand" height="35" />
      </a>
      ...
      <ul class="nav nav-secondary my-0">
        ...
        <li class="nav-item" >
          ...
          <div class="collapse" id="game">
            <ul class="nav nav-collapse py-0">
              <li class="nav-item" >
                <a href="{{ route('games.index') }}" class="nav-link" style="padding-top: 0.375rem !important; padding-bottom: 0.375rem !important;" >
                  <i class="far fa-circle" ></i>
        ...
        <li class="nav-item" >
          ...
          <div class="collapse" id="user" >
            <ul class="nav nav-collapse py-0" >
              <li class="nav-item" >
                <a href="{{ route('users.index') }}" class="nav-link" style="padding-top: 0.375rem !important; padding-bottom: 0.375rem !important;" >
                  <i class="far fa-circle" ></i>
                  <span class="ms-2" >{{ __('Manage Users') }}</span>
                </a>
              </li>
              <li class="nav-item" >
                <a href="{{ route('users.create') }}" class="nav-link" style="padding-top: 0.375rem !important; padding-bottom: 0.375rem !important;" >
                  <i class="far fa-circle" ></i>
